...
for agent_assignment in GCAA_Assignments:
    ...
    plt.plot(agent_x, agent_y, marker='o', markersize=8, color=agent_color, label=f"Agent {agent_id}")
    plt.plot(task_x, task_y, marker='s', markersize=8, color='red', label=f"Task {assigned_task}")
plt.legend()
